...
class Items extends Component {
  ...
  render() {
    ...
    if (routeContact) {
      return <Redirect to="/contact" push />;
    }
    return (
      <IconMenu
        iconButtonElement={
      ...
      >
        <MenuItem primaryText="Back to Home" onTouchTap={this.onLinkTap} />
        <Divider />
        <MenuItem primaryText="Contact Me" onTouchTap={this.onContactTap} />
      </IconMenu>
    );
  }
}
